...
const PatientCompletedAppointment = () => {
  return (
              ...
              <div className="appointment-wrap appointment-detail-card">
                <ul>
                  ...
                  <li className="appointment-info">
                    ...
                    <div className="person-info">
                      ...
                      <ul className="d-flex apponitment-types">
                        <li><i className="isax isax-video5 text-indigo"></i>Video Call</li>
                      </ul>
                    </div>
                  </li>
                ...
                <ul className="detail-card-bottom-info">
                  ...
                  <li className="detail-badge-info">
                    <a href="#view_prescription" data-bs-toggle="modal" className="btn btn-light rounded-pill me-3">Download Prescription</a>
                    <a href="#" className="btn reschedule-btn btn-primary-gradient rounded-pill">Reschedule Appointment</a>
                  </li>
                </ul>
              </div>
              {/* /Appointment Detail Card */}
...
export default PatientCompletedAppointment
