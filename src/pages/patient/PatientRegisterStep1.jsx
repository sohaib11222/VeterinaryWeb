              ...
              <div className="inner-right-login">
                <div className="login-header">
                  ...
                  <div className="step-list">
                    <ul>
                      <li><a href="javascript:;" className="active">1</a></li>
                  ...
                  <form id="profile_pic_form" encType="multipart/form-data">
                    ...
                    <div className="mt-5">
                      <Link to="/patient-register-step2" className="btn btn-primary w-100 btn-lg login-btn step1_submit">Continue</Link>
                    </div>
                  </form>
                </div>
              </div>
