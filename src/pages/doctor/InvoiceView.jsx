...
import { useVeterinarianInvoice } from '../../queries'
import { getImageUrl } from '../../utils/apiConfig'

const InvoiceView = () => {
  const { transactionId } = useParams()
  const location = useLocation()
  const { data, isLoading } = useVeterinarianInvoice(transactionId)
          ...
          <div className="col-lg-8 offset-lg-2">
            <div className="invoice-content">
              ...
              <div className="other-info">
                ...
                <p className="mb-0">An account of the present illness, which includes the circumstances surrounding the onset of recent health changes and the chronology of subsequent events that have led the patient to seek medicine</p>
              </div>
