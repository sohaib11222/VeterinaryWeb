        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6">
              <div className="mb-4">
                <h3>Found <span className="text-secondary">06</span> Doctors For You</h3>
              </div>
            </div>
            <div className="col-md-6">
                ...
                <div className="card-body">
                  <div id="map" style={{ height: '600px' }}>
                    ...
                    <div className="text-center p-5">
                      ...
                      <p className="mt-3">Map View with Availability</p>
                    </div>
                  </div>
                </div>
              </div>
...
export default MapListAvailability
